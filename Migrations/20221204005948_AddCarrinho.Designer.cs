...
namespace Projeto_Final.Migrations
{
    ...
    [Migration("20221204005948_AddCarrinho")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto_Final.Models.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Final.Models.Carrinho", b =>
                {
                    b.HasOne("Projeto_Final.Models.Consumidor", "Consumidor")
                        .WithOne("Carrinho")
                        .HasForeignKey("Projeto_Final.Models.Carrinho", "ConsumidorId")
            ...
            modelBuilder.Entity("Projeto_Final.Models.Produto", b =>
                {
                    b.HasOne("Projeto_Final.Models.Carrinho", null)
                        .WithMany("Produtos")
